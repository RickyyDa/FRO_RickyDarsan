...
let Ricky = document.querySelector('.fb__Ricky');
...
const animeren = () => {
  ...
  setTimeout( () => {Ricky.classList.remove('fb--uit')}, 600);
...
// banner linken
const gaNaarPagina = () => window.open('http://25296.hosts.ma-cloud.nl/bewijzenmap/periode1.1/fro/ikProject/index.html', '_blank')
